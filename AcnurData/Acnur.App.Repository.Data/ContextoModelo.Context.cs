...
namespace Acnur.App.Entities
{
    ...
    public partial class ACNUREntities : DbContext
    {
    	...
    	/// <summary>
        /// Atributo OtherObjects
        /// </summary>
        public virtual DbSet<OtherObjects> OtherObjects { get; set; }
        ...
        /// <summary>
        /// Obtains the mail text.
        /// </summary>
        /// <param name="gUID">The g uid.</param>
        /// <param name="mailText">The mail text.</param>
        /// <returns>System.Int32.</returns>
        public virtual int ObtainMailText(string gUID, System.Data.Entity.Core.Objects.ObjectParameter mailText)
        {
            var gUIDParameter = gUID != null ?
                new System.Data.Entity.Core.Objects.ObjectParameter("GUID", gUID) :
                new System.Data.Entity.Core.Objects.ObjectParameter("GUID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ObtainMailText", gUIDParameter, mailText);
        }
    }
}
